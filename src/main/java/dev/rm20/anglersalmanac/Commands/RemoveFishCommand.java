...
public class RemoveFishCommand extends AbstractPlayerCommand {
    ...
    protected void execute(@Nonnull CommandContext commandContext, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
        ...
        if (input.equals("*")) {
            ...
            commandContext.sendMessage(Message.raw("Removed all " + allFish.size() + " fish in your Almanac!"));
        } else {
            ...
            if (isValid) {
                ...
                commandContext.sendMessage(Message.raw("Removed " + input + " in your Almanac."));
            } else {
